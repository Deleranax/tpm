...
--- @return table, string Package manifest (or nil), the error message.
function github.fetchManifest(url, package)
    local request, message = http.get(get_file_url(url, package.."/manifest.json"))
